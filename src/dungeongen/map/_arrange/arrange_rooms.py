...
from dungeongen.graphics.conversions import map_to_grid
from dungeongen.graphics.math import Point2D
from dungeongen.graphics.shapes import Circle, Rectangle
from dungeongen.map._arrange.arrange_utils import (
    get_room_direction, grid_points_to_grid_rect, grid_line_to_grid_deltas,
    grid_line_dist, get_adjacent_room_rect
)
from dungeongen.map._arrange.passage_distribution import PassageConfig
from dungeongen.map._arrange.room_distribution import RoomShape, get_random_room_shape
from dungeongen.map.door import Door, DoorOrientation, DoorType
from dungeongen.map.enums import Direction, RoomDirection
...
def arrange_rooms(
    ...
    """
    from dungeongen.map._arrange.strategy_distribution import get_random_arrange_strategy
