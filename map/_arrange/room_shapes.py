...
ROOM_DISTRIBUTION: List[Tuple[Tuple[float, float, float], RoomShape | Callable, None]] = [
    ...
    ((0.6, 0.8, 0.6), make_room_shape(RoomType.CIRCULAR, 5, 5), None),
    ((0.6, 0.8, 0.6), make_room_shape(RoomType.CIRCULAR, 7, 7), None),
    ((0.6, 0.8, 0.6), make_room_shape(RoomType.CIRCULAR, 9, 9), None),
    ...
    # 3 breadth rectangular rooms
    ((0.3, 0.8, 1.2), make_room_shape(RoomType.RECTANGULAR, 3, 5), None),
    ((0.02, 0.05, 0.1), make_room_shape(RoomType.RECTANGULAR, 3, 7), None)
    ((0.02, 0.05, 0.1), make_room_shape(RoomType.RECTANGULAR, 3, 8), None)
    ((0.02, 0.05, 0.1), make_room_shape(RoomType.RECTANGULAR, 3, 9), None)
    ((0.02, 0.05, 0.1), make_room_shape(RoomType.RECTANGULAR, 3, 10), None)
    ((0.02, 0.05, 0.1), make_room_shape(RoomType.RECTANGULAR, 3, 12), None)

    # Asymetric low frequency room 4 breadth rooms (just 4x4)
    ((0.02, 0.05, 0.1), make_room_shape(RoomType.RECTANGULAR, 4, 4), None)

    # 5 breadth rooms
    ((0.02, 0.05, 0.1), make_room_shape(RoomType.RECTANGULAR, 5, 3), None)
    ((0.02, 0.05, 0.1), make_room_shape(RoomType.RECTANGULAR, 5, 5), None)
    ((0.02, 0.05, 0.1), make_room_shape(RoomType.RECTANGULAR, 5, 7), None)
    ((0.02, 0.05, 0.1), make_room_shape(RoomType.RECTANGULAR, 5, 9), None)

    # Todo (larger rooms are generated by a generator function) AI!
]
