...
class _RoomArranger:
    ...
    def arrange_linear(
        ...
        for _ in range(room_count - 1):
            ...
            room_shape = get_random_room_shape(options=self.map.options, breadth_offset=0.0)
...
def try_create_connected_room(
    ...
    # Create room shape
    room_shape = RoomShape(room_type or RoomType.RECTANGULAR, room_breadth, room_depth, breadth_offset=breadth_offset)
