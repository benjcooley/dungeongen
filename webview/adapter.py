...
from layout import Dungeon, Room as LayoutRoom, Passage as LayoutPassage, Door as LayoutDoor
from layout import RoomShape, DoorType as LayoutDoorType, Exit as LayoutExit, Stair as LayoutStair
...
def _convert_passage(
    ...
    from map.door import Door, DoorType, DoorOrientation
    from map.enums import RoomDirection
...
def _convert_stair(layout_stair: LayoutStair, dungeon_map: 'Map', offset_x: int, offset_y: int) -> None:
    ...
    from map.props import StairsProp
...
def _decorate_room(room: 'Room', seed: int, toward_spine: str) -> None:
    ...
    from map.props import ColumnType, Altar, Dias, Fountain
